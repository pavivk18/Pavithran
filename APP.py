...
IMAGE_DIR = r"D:\clg\PROJECT CAR FIRE\results\slides\cluster_representatives"
...
def upload_video():
    ...
    output_dirs = process_video_and_cluster(video_path, frame_rate=5, output_slides_dir=output_slides_dir,
...
def get_images():
    if not os.path.exists(IMAGE_DIR):
        return jsonify({"success": False, "message": "Image directory not found"})
